...
(function () {
  ...
  var translations = {
    nl: {
      ...
      "treatments.cat1.intro": "Preventieve zorg vormt de basis van een gezond gebit. Met regelmatige controles en een goede mondhygiëne voorkomen we problemen voordat ze ontstaan.",
      ...
      "treatments.cat2.intro": "Is er toch schade aan uw gebit, dan herstellen we dit met duurzame en esthetisch verantwoorde oplossingen. Ook voor een stralendere glimlach bent u bij ons aan het juiste adres.",
      ...
      "treatments.cat3.intro": "Voor complexere behandelingen werkt ons team nauw samen en verwijzen we, indien nodig, door naar een specialist voor de beste zorg.",
      ...
      "treatments.cat4.intro": "Bent u angstig voor de tandarts? U bent niet de enige. Onze angsttandarts neemt de tijd om u op uw gemak te stellen en past de behandeling aan uw tempo aan.",
    ...
    en: {
      ...
      "treatments.cat1.intro": "Preventive care is the foundation of a healthy smile. Regular check-ups and good oral hygiene help us catch problems before they start.",
      ...
      "treatments.cat2.intro": "When damage does occur, we restore it with durable, aesthetically sound solutions. We also offer options for a brighter smile.",
      ...
      "treatments.cat3.intro": "For more complex treatment our team works closely together, and refers you to a specialist when needed to make sure you get the best possible care.",
      ...
      "treatments.cat4.intro": "Anxious about visiting the dentist? You are not alone. Our anxiety-care dentist takes the time to put you at ease and adapts treatment to your pace.",
